...
- [linpad] added support for LINQPad 6 including new [nuget package](https://www.nuget.org/packages/linq2db.LINQPad)  ([#29](https://github.com/linq2db/linq2db.LINQPad/issues/33))
...
- [providers] removed ODP.NET Native Oracle provider (we still support managed provider, which doesn't require client installation)
...
- [providers] removed IBM DB2 iSeries support temporary because required [provider](https://github.com/LinqToDB4iSeries/Linq2DB4iSeries) lacks linq2db v3 support
...
- [misc] codebase updated to C# 8.0 and nullable reference types
